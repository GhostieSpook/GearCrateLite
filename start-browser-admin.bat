@echo off
REM ====================================
REM GearCrate - Browser Mode (ADMIN)
REM ====================================
...
echo ====================================
echo GearCrate - Browser Mode (ADMIN)
echo ====================================
echo.
echo Dieser Modus startet einen lokalen
echo Server mit Admin-Rechten und oeffnet
echo dein Browser.
echo.
echo Features:
echo - HTTP Server auf Port 8080
echo - Browser-basierte UI
